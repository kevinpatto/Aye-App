...
const routes: Routes = [
  ...
  // },
  { path: 'poop-form', component: PoopFormComponent, title: 'Aye - Poop Form' },
  {
    path: 'maintenance',
  ...
  { path: 'profile', component: ProfileComponent, title: 'Aye - Profile' },
  { path: '**', component: HomeComponent, title: 'Aye - Welcome' },
  { path: '', component: HomeComponent, title: 'Aye - Welcome' },
];
